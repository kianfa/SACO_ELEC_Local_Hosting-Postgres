...
export const metadata: Metadata = {
  title: "حساب کاربری من | الکتروساکو",
  description: "مشاهده اطلاعات حساب کاربری مشتریان الکتروساکو.",
}
            ...
            <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-3 max-w-2xl text-muted-foreground">
                  اطلاعات حساب کاربری شما برای ثبت سریع‌تر سفارش و ارتباط بهتر با پشتیبانی الکتروساکو استفاده می‌شود.
                </p>
              </div>
