          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_360px] lg:items-center">
            <div>
              ...
              <p className="mt-4 max-w-3xl text-base leading-8 text-muted-foreground md:text-lg">
                در الکتروساکو می‌توانید محصولات برندهای معتبر برق صنعتی، اتوماسیون، کنترل، ابزار دقیق و تجهیزات تابلو برق را بررسی و انتخاب کنید.
              </p>
            </div>
          ...
          <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm leading-7 text-primary-foreground/75">
                برای استعلام موجودی برندهای خاص یا محصولات پروژه‌ای، با کارشناسان الکتروساکو در ارتباط باشید.
              </p>
            </div>
