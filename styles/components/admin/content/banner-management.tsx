        ...
        <CardContent>
          <form action={formAction} className="space-y-4">
            ...
            {editing.imageUrl ? (
              <div className="overflow-hidden rounded-2xl border bg-muted">
                <SafeImageWithFallback
                  ...
                  altText={editing.imageAltText || editing.title || "بنر الکتروساکو"}
                  fallbackText={editing.title || "بنر الکتروساکو"}
                  objectFit="cover"
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">تصاویر جدید در فضای ذخیره‌سازی MinIO ذخیره می‌شوند و آدرس عمومی آن‌ها در دیتابیس ثبت می‌شود.</p>
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder={editing.title || "بنر الکتروساکو"}
